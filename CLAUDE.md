# Jantu — Claude Code Instructions

## Project Identity

**Jantu** (Sanskrit: जन्तु — creature/living being) — Ethology and creature behavior engine for AGNOS
...
AGNOS science stack, kiran (game engine), joshua (simulation), any app needing creature behavior, swarm AI, or ethology.
...
- Own the domain — jantu IS the creature behavior vocabulary
